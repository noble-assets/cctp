...
replace (
	...
	// use twilight compatible circlefin/noble-fiattokenfactory
	github.com/circlefin/noble-fiattokenfactory => github.com/noble-assets/fiattokenfactory v0.0.0-20231127135042-605b62653b7b
